...
Citizen.CreateThread(function()
	...
	while true do
		...
		WarMenu.Display()
		elseif IsControlJustReleased(0, 303) and GetVehiclePedIsIn( PlayerPedId(), false ) ~= 0 then -- Press B, also make sure we are in a vehicle otherwise the script will crash
